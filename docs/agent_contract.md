...
This document combines the shared integration contract from the model-training branch with the Trader Agent contract notes from the trader-agent branch.

---

## Shared model-training contract
...
## Trader Agent contract additions
