"""Shared response envelope for the multi-agent contract.
...
across MCP and REST agents without per-agent adapters.
"""
...
class AgentResponse(BaseModel):
    ...
    agent_name: Literal["risk_agent"] = "risk_agent"
    ...
    input_resolution: dict[str, Any] = Field(
        default_factory=dict, description="How input was interpreted (e.g. matched country name)."
    )
