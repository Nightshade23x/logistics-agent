    ...
    <>
      <div className="page-header">
        <div>
          ...
          <div className="page-subtitle">Full shipment breakdown, readiness gate, missing inputs, and agent results.</div>
        </div>
      </div>
            ...
            <div className="content-col">
              <SideInfoCard title="Backend validation" badge={<Badge status={result.backend_validation?.response_contract_valid ? "clear" : "blocked"} />}>
                <ul className="info-list">
                  <li><span className="label">Contract valid</span><span className="value">{result.backend_validation?.response_contract_valid ? "Yes" : "No"}</span></li>
              ...
              <SideInfoCard title="Request metadata">
                <ul className="info-list">
                  <li><span className="label">Type</span><span className="value">{humanizeKey(result.request_metadata?.request_type)}</span></li>
                  <li><span className="label">Served by</span><span className="value">{humanizeKey(result.request_metadata?.served_by)}</span></li>
                  <li><span className="label">Agents called</span><span className="value">{(result.agents_called || []).map(humanizeKey).join(", ")}</span></li>
                </ul>
              </SideInfoCard>
